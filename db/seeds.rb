...
f63 = Pin.create!({ title: "Fashion", body: "This hair looks amazing" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f63.jpg')
f63.photo.attach(io: file, filename: "f63.jpg")

f64 = Pin.create!({ title: "Fashion", body: "This style looks cool" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f64.jpg')
f64.photo.attach(io: file, filename: "f64.jpg")

f65 = Pin.create!({ title: "Fashion", body: "This style looks perfect" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f65.jpg')
f65.photo.attach(io: file, filename: "f65.jpg")

f66 = Pin.create!({ title: "Fashion", body: "This style looks amazing" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f66.jpg')
f66.photo.attach(io: file, filename: "f66.jpg")

f67 = Pin.create!({ title: "Fashion", body: "This one looks pretty" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f67.jpg')
f67.photo.attach(io: file, filename: "f67.jpg")

f68 = Pin.create!({ title: "Fashion", body: "This top looks very awesome" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f68.jpg')
f68.photo.attach(io: file, filename: "f68.jpg")

f69 = Pin.create!({ title: "Fashion", body: "This top looks very nice" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f69.jpg')
f69.photo.attach(io: file, filename: "f69.jpg")

f7 = Pin.create!({ title: "Fashion", body: "This top looks amazing" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f7.jpg')
f7.photo.attach(io: file, filename: "f7.jpg")

f70 = Pin.create!({ title: "Fashion", body: "This color looks nice" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f70.jpg')
f70.photo.attach(io: file, filename: "f70.jpg")

f71 = Pin.create!({ title: "Fashion", body: "This color looks perfect" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f71.jpg')
f71.photo.attach(io: file, filename: "f71.jpg")

f72 = Pin.create!({ title: "Fashion", body: "This hair looks amazing" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f72.jpg')
f72.photo.attach(io: file, filename: "f72.jpg")

f8 = Pin.create!({ title: "Fashion", body: "This fashion looks amazing" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f8.jpg')
f8.photo.attach(io: file, filename: "f8.jpg")

f9 = Pin.create!({ title: "Fashion", body: "This color looks amazing" , board_id: b10.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/f9.jpg')
f9.photo.attach(io: file, filename: "f9.jpg")

###Food
e1 = Pin.create!({ title: "Food", body: "This food looks amazing" , board_id: b2.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/e1.jpg')
e1.photo.attach(io: file, filename: "e1.jpg")

e10 = Pin.create!({ title: "Food", body: "This sushi looks amazing" , board_id: b2.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/e10.jpg')
e10.photo.attach(io: file, filename: "e10.jpg")

e11 = Pin.create!({ title: "Food", body: "This is a good sushi" , board_id: b2.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/e11.jpg')
e11.photo.attach(io: file, filename: "e11.jpg")

e12 = Pin.create!({ title: "Food", body: "This food looks so good" , board_id: b2.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/e12.jpg')
e12.photo.attach(io: file, filename: "e12.jpg")

e14 = Pin.create!({ title: "Food", body: "This sushi looks nice", board_id: b5.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e14.jpg")
e14.photo.attach(io: file, filename: "e14.jpg")

e15 = Pin.create!({ title: "Food", body: "This noodle looks amazing", board_id: b5.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e15.jpg")
e15.photo.attach(io: file, filename: "e15.jpg")

e16 = Pin.create!({ title: "Food", body: "This is a good noodle", board_id: b5.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e16.jpg")
e16.photo.attach(io: file, filename: "e16.jpg")

e17 = Pin.create!({ title: "Food", body: "This dry noddle looks so good", board_id: b5.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e17.jpg")
e17.photo.attach(io: file, filename: "e17.jpg")

e18 = Pin.create!({ title: "Food", body: "This one looks good", board_id: b8.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e18.jpg")
e18.photo.attach(io: file, filename: "e18.jpg")

e19 = Pin.create!({ title: "Food", body: "This shrim noodle looks amazing", board_id: b8.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e19.jpg")
e19.photo.attach(io: file, filename: "e19.jpg")

e20 = Pin.create!({ title: "Food", body: "This is a good noodle", board_id: b8.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e20.jpg")
e20.photo.attach(io: file, filename: "e20.jpg")

e21 = Pin.create!({ title: "Food", body: "This asian dry noddle very good", board_id: b8.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e21.jpg")
e21.photo.attach(io: file, filename: "e21.jpg")

e30 = Pin.create!({ title: "Food", body: "This shrim looks good", board_id: b11.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e30.jpg")
e30.photo.attach(io: file, filename: "e30.jpg")

e23 = Pin.create!({ title: "Food", body: "This chicken looks amazing", board_id: b11.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e23.jpg")
e23.photo.attach(io: file, filename: "e23.jpg")

e25 = Pin.create!({ title: "Food", body: "This is a good chicken meat", board_id: b11.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e25.jpg")
e25.photo.attach(io: file, filename: "e25.jpg")

e26 = Pin.create!({ title: "Food", body: "This chicken thight very good", board_id: b11.id })
file = open("https://binterest-seeds.s3-us-west-1.amazonaws.com/e26.jpg")
e26.photo.attach(io: file, filename: "e26.jpg")
