...
p1 = Pin.create!({ title: "Place", body: "This is very nice" , board_id: b3.id})
file = open('https://binterest-seeds.s3-us-west-1.amazonaws.com/p1.jpg')
p1.photo.attach(io: file, filename: "p1.jpg")

p2 = Pin.create!({ title: "Place", body: "This is very nice" , board_id: b3.id})
